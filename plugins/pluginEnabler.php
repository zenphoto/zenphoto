...
class pluginEnabler {
	...
	static function buttons($buttons) {
		...
		$buttons[] = array(
				...
				'formname' => 'enablebutton',
				'action' => FULLWEBPATH . '/' . USER_PLUGIN_FOLDER . '/pluginEnabler/handler.php',
				'icon' => '<span style="color:blue;font-size:large;line-height: 60%;">' . HEAVY_BLACK_CURVED_UPWARDS_AND_RIGHTWARDS_ARROW . '</span>',
		...
		$buttons[] = array(
				...
				'formname' => 'enablebutton',
				'action' => FULLWEBPATH . '/' . USER_PLUGIN_FOLDER . '/pluginEnabler/handler.php',
				'icon' => '<span style="color:green;font-size: large;line-height: 60%;">' . ARROW_DOWN . '</span>',
