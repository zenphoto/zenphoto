...
class ThemeOptions {
	...
	function ThemeOptions() {
		...
		if (class_exists('cacheManager')) {
			...
			cacheManager::addThemeCacheSize('default', 595, NULL, NULL, NULL, NULL, NULL, NULL, false, getOption('fullimage_watermark'), NULL);
			cacheManager::addThemeCacheSize('default', 100, NULL, NULL, getThemeOption('thumb_crop_width'), getThemeOption('thumb_crop_height'), NULL, NULL, true, getOption('Image_watermark'), NULL);
		}
	}
