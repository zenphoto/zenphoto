...
?>
	...
	<!-- .container main -->
		...
		while (next_image(true)) {
			$year = substr(getBareImageTitle(), -4);
		...
		<div class="pager">
			<div class="btn-group filters-button-group">
				...
				<?php foreach ($years as $year) { ?>
					<button class="btn btn-default btn-sm" data-filter=".<?php echo $year; ?>"><?php echo $year; ?></button>
				<?php } ?>
			</div>
		</div>
		...
		<div id="isotope-wrap" class="images-wrap margin-bottom-double">
			...
			while (next_image(true)) {
				...
				<div class="image-item<?php echo $image_item_size_2 . ' ' . substr(getBareImageTitle(), -4); ?>">
