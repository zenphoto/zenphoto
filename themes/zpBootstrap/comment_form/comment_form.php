					<form id="commentform" class="form-horizontal" action="#commentform" method="post">
						...
						if (getOption('comment_form_private') && !$disabled['private']) { ?>
							<div class="control-group controls">
								<label class="checkbox" for="private">
									<input type="checkbox" id=for="private" name="private" value="1"<?php if ($stored['private']) echo ' checked="checked"'; ?> />
						...
						<div class="control-group">
								<textarea name="comment" rows="6" cols="42" class="span6"><?php echo $stored['comment']; echo $disabled['comment']; ?></textarea>
						</div>
