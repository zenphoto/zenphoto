	...
	<?php while (next_image()) { ?>
		...
		<?php if (!empty($fullimage)) { ?>
			<div class="col-xs-6 col-sm-3 image-thumb">
				<a class="thumb swipebox" href="<?php echo pathurlencode($fullimage); ?>" title="<?php echo html_encode(getBareImageTitle()); ?>" data-fancybox="fancybox" data-caption="<?php echo getBareImageTitle(); ?>">
