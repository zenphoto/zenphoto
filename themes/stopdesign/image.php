...
<head>
	...
	<title><?php echo html_encode(getBareImageTitle());?></title>
		...
		<div id="content" class="v">
			...
			<div id="meta">
				...
				<?php
					...
					if (!empty($fullimage)) {
						?>
						<a href="<?php echo html_encode($fullimage);?>" title="<?php echo html_encode(getBareImageTitle());?>"><?php echo gettext('Full Size'); ?></a>
						<?php
					}
					?>
 					</li>
