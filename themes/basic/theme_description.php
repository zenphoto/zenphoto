...
$theme_description['desc'] = gettext("The simplest Zenphoto theme in 4 distinct flavors. After choosing this theme you can pick the theme color by going to the Admin Options tab and changing the <em>Theme colors</em> option.");
?>