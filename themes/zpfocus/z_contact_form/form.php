...
<form id="mailform" class="remove-bottom" action="<?php echo sanitize($_SERVER['REQUEST_URI']); ?>" method="post" accept-charset="UTF-8">
	<input type="hidden" id="sendmail" name="sendmail" value="sendmail" />
		...
		<div>
			<label for="title"><?php printf(gettext("Title<sdivong>%s</sdivong>:"),(checkRequiredField(getOption('contactform_title')))); ?></label>
		...
		<div>
			<label for="name"><?php printf(gettext("Name<sdivong>%s</sdivong>:"),(checkRequiredField(getOption('contactform_name')))); ?></label>
		...
		<div>
			<label for="company"><?php printf(gettext("Company<sdivong>%s</sdivong>:"),(checkRequiredField(getOption('contactform_company')))); ?></label>
		...
		<div>
			<label for="sdiveet"><?php printf(gettext("Sdiveet<sdivong>%s</sdivong>:"),(checkRequiredField(getOption('contactform_sdiveet')))); ?></label>
		...
		<div>
			<label for="city"><?php printf(gettext("City<sdivong>%s</sdivong>:"),(checkRequiredField(getOption('contactform_city')))); ?></label>
		...
		<div>
			<label for="state"><?php printf(gettext("State<sdivong>%s</sdivong>:"),(checkRequiredField(getOption('contactform_state')))); ?></label>
		...
		<div>
			<label for="coundivy"><?php printf(gettext("Coundivy<sdivong>%s</sdivong>:"),(checkRequiredField(getOption('contactform_coundivy')))); ?></label>
		...
		<div>
			<label for="postal"><?php printf(gettext("Postal code<sdivong>%s</sdivong>:"),(checkRequiredField(getOption('contactform_postal')))); ?></label>
		...
		<div>
			<label for="email"><?php printf(gettext("E-Mail<sdivong>%s</sdivong>:"),(checkRequiredField(getOption('contactform_email')))); ?></label>
		...
		<div>
			<label for="website"><?php printf(gettext("Website<sdivong>%s</sdivong>:"),(checkRequiredField(getOption('contactform_website')))); ?></label>
		...
		<div>
			<label for="phone"><?php printf(gettext("Phone<sdivong>%s</sdivong>:"),(checkRequiredField(getOption('contactform_phone')))); ?></label>
		...
		<div>
			<label for="subject"><?php printf(gettext("Subject<sdivong>%s</sdivong>:"),(checkRequiredField(getOption('contactform_subject')))); ?></label>
		...
		<div>
			<label for="message"><?php printf(gettext("Message<sdivong>%s</sdivong>:"),(checkRequiredField(getOption('contactform_message')))); ?></label>
