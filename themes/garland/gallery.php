...
<div id="wrapper">
	<div id="container">
		<div id="header">
			<div id="logo-floater">
				<div>
          <h1 class="title"><a href="<?php echo getGalleryIndexURL(false);?>" title="Gallery Index"><?php echo getGalleryTitle();?></a></h1>
				</div>
			</div>
		</div>
	<!-- header -->
		...
		<div id="squeeze">
			...
			<div class="left-corner"><!-- begin content -->
				<div class="main section" id="main">
					<h3 id="gallerytitle"><a href="<?php echo getGalleryIndexURL(false);?>" title="Gallery Index"><?php echo getGalleryTitle();?></a> &raquo; <?php echo gettext('Album index'); ?></h3>
					<?php
