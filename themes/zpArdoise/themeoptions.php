...
class ThemeOptions {
	...
	function getOptionsSupported() {
		return array(
						...
						gettext('Galleriffic slideshow delay') => array('order' => 10, 'key' => 'galleriffic_delai', 'type' => OPTION_TYPE_NUMBER, 'desc' => gettext('If Galleriffic is used, enter the delay of the gallerific slideshow in ms (eg 3000).')),
