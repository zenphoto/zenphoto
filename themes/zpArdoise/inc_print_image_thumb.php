		...
		<?php while (next_image()) { ?>
			<li class="no-gal-li">
				...
				<?php if ((getOption('use_colorbox_album')) && (!empty($fullimage))) { ?>
					<a class="thumb colorbox" href="<?php echo pathurlencode($fullimage); ?>" title="<?php echo html_encode(getBareImageTitle()); ?>"><?php printImageThumb(getAnnotatedImageTitle()); ?></a>
				<?php } else { ?>
