...
<head>
	...
	if ($_zp_gallery_page == 'image.php') {echo ' | ' . getBareAlbumTitle() . ' | ' . html_encode(getBareImageTitle()); }
...
<div id="page">
	...
	<div id="site-title" class="clearfix">
		...
		<!-- banniere -->
		<div id="banniere">
			<a href="<?php echo html_encode(getGalleryIndexURL() /*TODO:replaced getSiteHomeURL() */); ?>" title="<?php echo gettext('Home'); ?>"><img id="zplogo" src="<?php echo $_zp_themeroot; ?>/images/<?php echo getOption('use_image_logo_filename'); ?>" alt="<?php echo getGalleryTitle(); ?>" /></a>
		</div>
	</div>
	<?php } ?>
