	...
	<div id="headline-news">
		<?php if (is_NewsArticle()) { ?>
			<div class="control-nav-news">
				...
				echo $article_url['link']; ?>" title="<?php echo $article_url['title']; ?>">&laquo; <?php echo gettext('newer'); ?></a></li>
						<?php } else { ?>
						...
						<?php if (getNextNewsURL()) { ?>
							...
							echo $article_url['link']; ?>" title="<?php echo $article_url['title']; ?>"><?php echo gettext('older'); ?> &raquo;</a></li>
						<?php } else { ?>
