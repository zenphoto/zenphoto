...
class ThemeOptions {
	...
	function getOptionsSupported() {
		return array(
						...
						gettext('Menu Name of Menu Manager')							 => array('key' => 'zpmin_menu', 'type' => OPTION_TYPE_TEXT, 'multilingual' => false, 'desc' => gettext('If you use the menu manager plugin, enter the name of the menu you would like to use.  Make sure you create the menu in the menu manager backend! Or leave blank to use the theme menu.')),
