<?php include ("inc-header.php"); ?>
	<div class="wrapper contrast top">
		<div class="container">	
			...
			if ($zenpage && !isArchive()) {
				...
				if ($zpskel_usenews) { $numnews = getNumNews(); } else { $numnews = 0; }
	...
	<div class="wrapper">
		<div class="container">
			...
			<div class="eight columns">
			<?php if (($numnews > 0) && ($zpskel_usenews)) {
				$number_to_show = 5;
				$c = 0;
				?>
			...
			<?php $c++; $mobilebreak = $c%2; if ($c==$breakcount) { echo '<br class="clear clearforboth" />'; $c=0; } else if ($mobilebreak == 0) { echo '<br class="clear clearformobile" />'; } endwhile; ?>
			<?php } ?>
