		...
		<div id="footer" class="row">
			<div class="col-sm-9" id="footer-menu">
				<ul class="list-inline">
					...
					<?php if (getOption('display_archive')) { ?><li><?php printCustomPageURL(gettext('Archive View'), 'archive'); ?></li><?php } ?>
					<?php if (function_exists("printAllNewsCategories") && ((getNumNews(true)) > 0)) { ?><li><?php printNewsIndexURL(gettext('News'), '', gettext('News')); ?></li><?php } ?>
			...
			<div class="col-sm-3 text-right" id="social">
				<p>	
					...
					?>
					<?php if (getOption('googleplus_page_url')!='') {
						echo '<a href="';
