 ...
 * Place <code>printjCarousel()</code> on your theme's image.php where you want it to appear.
 *
 * Supports theme based custom css files (place <code>jcarousel.css</code> and needed images in your theme's folder).
 *
