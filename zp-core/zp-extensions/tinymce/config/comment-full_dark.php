...
$MCEplugins = "advlist autolink lists link image charmap hr anchor pagebreak " .
				...
				"emoticons paste";
$MCEtoolbars[1] = "undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify ltr rtl | bullist numlist outdent indent | link image | searchreplace visualchars | emoticons | code";
$MCEstatusbar = false;
$MCEmenubar = false;
