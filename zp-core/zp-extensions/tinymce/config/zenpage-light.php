...
$MCEplugins = "advlist autolink lists link image charmap anchor " .
				...
				"insertdatetime media table contextmenu paste pasteobj tinyzenpage";
$MCEtoolbars[1] = "insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image pasteobj tinyzenpage searchreplace visualchars";
$MCEstatusbar = true;
$MCEmenubar = false;
