...
$MCEtoolbars[1] = "insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image tinyzenpage | code pastezen fullscreen";
$MCEstatusbar = true;
$MCEmenubar = true;
