...
$plugin_disable = (zp_has_filter('seoFriendly') && !getoption('zp_plugin_seo_zenphoto'))?sprintf(gettext('Only one SEO filter plugin may be enalbed. <code>%s</code> is already enabled.'),stripSuffix(get_filterScript('seoFriendly'))):'';
