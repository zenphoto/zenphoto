...
$plugin_disable = (filter::hasFilter('seoFriendly') && !extensionEnabled('seo_zenphoto')) ? sprintf(gettext('Only one SEO filter plugin may be enabled. <a href="#%1$s"><code>%1$s</code></a> is already enabled.'), stripSuffix(filter::getFilterScript('seoFriendly'))) : '';
...
if ($plugin_disable) {
	...
	filter::registerFilter('seoFriendly', 'zenphoto_seo::filter');
	filter::registerFilter('seoFriendly_js', 'zenphoto_seo::js');
}
