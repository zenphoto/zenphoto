			...
			<div class="tabbox">
				...
				if (zp_loggedin(ADMIN_RIGHTS)) { //only admin should be allowed to do this
					...
					<fieldset class="smallbox">
						...
						<div id="pubbox">
							...
							?>
							<form class="dirtylistening" onReset="setClean('set_publication_form');" id="set_publication_form" name="set_publication" action="" method="post" autocomplete="off">
				...
				<fieldset class="smallbox">
					...
					<div id="albumbox"<?php if (!$visible) echo ' style="display:none"' ?>>
						...
						if ($c > 0) {
							?>
							<form class="dirtylistening" onReset="setClean('publish_albums_form');" id="publish_albums_form" name="publish_albums" action="" method="post" autocomplete="off"><?php echo gettext('Albums:'); ?>
								<label id="autocheck">
				...
				<fieldset class="smallbox">
					...
					<div id="imagebox"<?php if (!$visible) echo ' style="display:none"' ?>>
						...
						if ($c > 0) {
							...
							<form class="dirtylistening" onReset="setClean('publish_images_form');" id="publish_images_form" name="publish_images" action="" method="post" autocomplete="off"><?php echo gettext('Images:'); ?>
					...
					<fieldset class="smallbox">
						...
						if ($output) {
							...
							<div id="catbox"<?php if (!$visible) echo ' style="display:none"' ?>>
								...
								?>
								<form class="dirtylistening" onReset="setClean('publish_cat_form');" id="publish_cat_form" name="publish_cat" action="" method="post" autocomplete="off"><?php echo gettext('Categories:'); ?>
					...
					<fieldset class="smallbox">
						...
						if ($output) {
							...
							<div id="newsbox"<?php if (!$visible) echo ' style="display:none"' ?>>
								...
								?>
								<form class="dirtylistening" onReset="setClean('publish_articles_form');" id="publish_articles_form" name="publish_articles" action="" method="post" autocomplete="off"><?php echo gettext('Articles:'); ?>
					...
					<fieldset class="smallbox">
						...
						if ($output) {
							...
							<div id="pagebox"<?php if (!$visible) echo ' style="display:none"' ?>>
								<form class="dirtylistening" onReset="setClean('publish_pages_form');" id="publish_pages_form" name="publish_pages" action="" method="post" autocomplete="off"><?php echo gettext('Pages:'); ?>
