			...
			<div class="tabbox">
				...
				if (zp_loggedin(ADMIN_RIGHTS)) { //only admin should be allowed to do this
					...
					<fieldset class="smallbox">
						...
						<div id="pubbox">
							...
							?>
							<form class="dirtylistening" name="set_publication" action="" method="post">
				...
				<fieldset class="smallbox">
					...
					<div id="albumbox"<?php if (!$visible) echo ' style="display:none"' ?>>
						...
						if ($c > 0) {
							?>
							<form class="dirtylistening" name="publish_albums" action="" method="post"><?php echo gettext('Albums:'); ?>
								<label id="autocheck">
				...
				<fieldset class="smallbox">
					...
					<div id="imagebox"<?php if (!$visible) echo ' style="display:none"' ?>>
						...
						if ($c > 0) {
							...
							<form class="dirtylistening" name="publish_images" action="" method="post"><?php echo gettext('Images:'); ?>
					...
					<fieldset class="smallbox">
						...
						if ($output) {
							...
							<div id="catbox"<?php if (!$visible) echo ' style="display:none"' ?>>
								...
								?>
								<form class="dirtylistening" name="publish_cat" action="" method="post"><?php echo gettext('Categories:'); ?>
					...
					<fieldset class="smallbox">
						...
						if ($output) {
							...
							<div id="newsbox"<?php if (!$visible) echo ' style="display:none"' ?>>
								...
								?>
								<form class="dirtylistening" name="publish_articles" action="" method="post"><?php echo gettext('Articles:'); ?>
					...
					<fieldset class="smallbox">
						...
						if ($output) {
							...
							<div id="pagebox"<?php if (!$visible) echo ' style="display:none"' ?>>
								<form class="dirtylistening" name="publish_pages" action="" method="post"><?php echo gettext('Pages:'); ?>
