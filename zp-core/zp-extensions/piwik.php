...
if (getOption('piwik_widgets_code')) {
	zp_register_filter('admin_tabs', 'piwikStats::admin_tabs');
}
...
class piwikStats {
	...
	static function admin_tabs($tabs) {
		if (zp_loggedin(OVERVIEW_RIGHTS)) {
			$tabs['overview']['subtabs'][gettext('Piwik statistics')] = '/' . ZENFOLDER . '/' . PLUGIN_FOLDER . '/piwik/piwik_tab.php?tab=piwik';
		}
		return $tabs;
	}
