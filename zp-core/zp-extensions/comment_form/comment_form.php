<form id="commentform" action="#commentform" method="post">
	...
	if (getOption('comment_name_required')) {
		...
		<p>
			...
			<input<?php printCommenetFormFieldAttributes('comment_name_required', $disabled['name']); ?> type="text" id="name" name="name" size="22" value="<?php echo html_encode($stored['name']); ?>" class="inputbox" />
		</p>
		<?php
	...
	if (getOption('comment_email_required')) {
		...
		<p>
			...
			<input<?php printCommenetFormFieldAttributes('comment_email_required', $disabled['email']); ?> type="email" id="email" name="email" size="22" value="<?php echo html_encode($stored['email']); ?>" class="inputbox" />
		</p>
		<?php
	}
	if (getOption('comment_web_required')) {
		...
		<p>
			...
			<input<?php printCommenetFormFieldAttributes('comment_web_required', $disabled['website']); ?> type="url" id="website" name="website" size="22" value="<?php echo html_encode($stored['website']); ?>" class="inputbox" />
		</p>
		<?php
	}
	if (getOption('comment_form_addresses')) {
		...
		<p>
			...
			<input<?php printCommenetFormFieldAttributes('comment_form_addresses', $disabled['street']); ?> type="text" name="0-comment_form_street" id="0-comment_form_street" class="inputbox" size="22" value="<?php echo html_encode($stored['street']); ?>" />
		</p>
		<p>
			<label for="0-comment_form_city"><?php printf(gettext('City%s'), getCommentFormRequiredFieldMark('comment_form_addresses')); ?></label>
			<input<?php printCommenetFormFieldAttributes('comment_form_addresses', $disabled['city']); ?> type="text" name="0-comment_form_city" id="0-comment_form_city" class="inputbox" size="22" value="<?php echo html_encode($stored['city']); ?>" />
		</p>
		<p>
			<label for="comment_form_state"><?php printf(gettext('State%s'), getCommentFormRequiredFieldMark('comment_form_addresses')); ?></label>
			<input<?php printCommenetFormFieldAttributes('comment_form_addresses', $disabled['state']); ?> type="text" name="0-comment_form_state" id="comment_form_state" class="inputbox" size="22" value="<?php echo html_encode($stored['state']); ?>" />
		</p>
		<p>
			<label for="comment_form_country"><?php printf(gettext('Country%s'), getCommentFormRequiredFieldMark('comment_form_addresses')); ?></label>
			<input<?php printCommenetFormFieldAttributes('comment_form_addresses', $disabled['country']); ?> type="text" id="comment_form_country" name="0-comment_form_country" class="inputbox" size="22" value="<?php echo html_encode($stored['country']); ?>" />
		</p>
		<p>
			...
			<input<?php printCommenetFormFieldAttributes('comment_form_addresses', $disabled['postal']); ?> type="text" id="comment_form_postal" name="0-comment_form_postal" class="inputbox" size="22" value="<?php echo html_encode($stored['postal']); ?>" />
		</p>
		<?php
	}
