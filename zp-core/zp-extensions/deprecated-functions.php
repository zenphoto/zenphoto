...
function getURL($image) {
	deprecated_functions::notify(gettext('Use the appropriate object method. <strong>Note: this function gives different results depending on the setting of <code>mod_rewrite</strong> so which object method to use depends on what your settings were!'));
