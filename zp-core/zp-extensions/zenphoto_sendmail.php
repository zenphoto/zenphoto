...
$plugin_disable = (zp_has_filter('sendmail') && !getoption('zp_plugin_zenphoto_sendmail'))?sprintf(gettext('Only one Email handler plugin may be enalbed. <code>%s</code> is already enabled.'),stripSuffix(get_filterScript('sendmail'))):'';
