...
filter::registerFilter('standard_image_thumb_html', 'flag_thumbnail::std_image_thumbs');
filter::registerFilter('standard_album_thumb_html', 'flag_thumbnail::std_album_thumbs', 99);
filter::registerFilter('custom_album_thumb_html', 'flag_thumbnail::custom_album_thumbs', 99);
filter::registerFilter('custom_image_html', 'flag_thumbnail::custom_images', 99);
