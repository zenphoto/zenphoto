	...
	<div id="main">
		...
		<div id="content">
			...
			<div id="tab_articles" class="tabbox">
				...
				<form class="dirtylistening" action="admin-categories.php?page=news&amp;tab=categories" method="post" id="checkeditems" name="checkeditems" onsubmit="return confirmAction();">
