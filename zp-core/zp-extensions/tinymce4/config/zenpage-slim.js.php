...
?>
					plugins: [
									...
									toolbar: "styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image <?php if (extensionEnabled('tinyZenpage')) echo "tinyzenpage"; ?> | code fullscreen",
									setup: function(ed) {
