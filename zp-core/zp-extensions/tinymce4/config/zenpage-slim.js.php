...
?>
					plugins: [
									...
									toolbar: "styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image tinyzenpage | code fullscreen | ltr rtl",
									setup: function(ed) {
