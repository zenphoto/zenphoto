...
class xmpMetadata {
	...
	static function getMetadataFields() {
		return array(
				...
				'XMPFNumber' => array('XMP', '<exif:FNumber>', gettext('Aperture'), true, 52, true, 'string'),
				'XMPFocalLength' => array('XMP', '<exif:FocalLength>', gettext('Focal Length'), true, 52, true, 'string'),
				...
				'XMPISOSpeedRatings' => array('XMP', '<exif:ISOSpeedRatings>', gettext('ISO Sensitivity'), true, 52, true, 'string'),
