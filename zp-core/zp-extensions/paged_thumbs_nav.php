...
class pagedthumbsOptions {
	...
	function __construct() {
		if (OFFSET_PATH == 2) {
			...
			setOptionDefault('pagedthumbs_prevtext', '');
			setOptionDefault('pagedthumbs_nexttext', '');
	...
	function getOptionsSupported() {
		return array(gettext('Thumbs per page') =>
				array('key' => 'pagedthumbs_imagesperpage',
				...
				gettext('Counter') => array(
						'key' => 'pagedthumbs_counter',
						'type' => OPTION_TYPE_CHECKBOX,
						'desc' => gettext("If you want to show the counter “x - y of z images”.")),
				gettext('Prevtext') => array(
						'key' => 'pagedthumbs_prevtext',
						'type' => OPTION_TYPE_TEXTBOX,
						'desc' => gettext("The text for the previous thumbs. Leave empty to use the default text."), 
						'multilingual' => 1),
				gettext('Nexttext') => array(
						'key' => 'pagedthumbs_nexttext',
						'type' => OPTION_TYPE_TEXTBOX,
						'desc' => gettext("The text for the next thumbs. Leave empty to use the default text."), 
						'multilingual' => 1),
				gettext('Crop width') => array(
						'key' => 'pagedthumbs_width',
						'type' => OPTION_TYPE_TEXTBOX,
				...
				gettext('Placeholders') => array(
						'key' => 'pagedthumbs_placeholders',
						'type' => OPTION_TYPE_CHECKBOX,
				...
				gettext('Page list') => array(
						'key' => 'pagedthumbs_pagelist',
						'type' => OPTION_TYPE_CHECKBOX,
						'desc' => gettext("If you want the list of the pages to be shown.")),
				gettext('Pages list prev and next links') => array(
						'key' => 'pagedthumbs_pagelistprevnext',
						'type' => OPTION_TYPE_CHECKBOX,
						'desc' => gettext("If you want to show previous and next thumb page links with the page list.")),
				gettext('Pages list length') => array(
						'key' => 'pagedthumbs_pagelistlength',
						'type' => OPTION_TYPE_CHECKBOX,
