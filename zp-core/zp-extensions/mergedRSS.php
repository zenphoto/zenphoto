...
if (isset($_GET['mergedrss'])) {
  ...
  $MergedRSS = new MergedRSS($feeds, getBare(i18n::getLanguageString($gallery->getTitle(), $locale)), FULLWEBPATH, getBare(i18n::getLanguageString($gallery->getDesc(), $locale)), $RSS_date);
