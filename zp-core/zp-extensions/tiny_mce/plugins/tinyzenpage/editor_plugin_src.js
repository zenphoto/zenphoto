...
(function() {
	...
	tinymce.PluginManager.requireLangPack('tinyzenpage');

	tinymce.create('tinymce.plugins.tinyzenpagePlugin', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addButton('tinyzenpage', {
				title : 'tinyzenpage.desc',
				cmd : 'mcetinyzenpage',
				image : url + '/img/tinyzenpage.gif'
			});

			// Add a node change handler, selects the button in the UI when a image is selected
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('tinyzenpage', n.nodeName == 'IMG');
			});
		},
	...
	// Register plugin
	tinymce.PluginManager.add('tinyzenpage', tinymce.plugins.tinyzenpagePlugin);
})();