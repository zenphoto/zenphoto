...
function detect_fetcher($r, &$out) {
	...
	$expected_url = 'https://raw.github.com/gist/465630/c57eff55ebc0c54973903af5f72bac72762cf4f4/helloworld';
...
$body .= '<a href="' . FULLWEBPATH . '/' . ZENFOLDER . '/admin-plugins.php">' . gettext('back to ZenPhoto20') . '</a>';
$out .= $body . $r->end();
