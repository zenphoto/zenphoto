...
require_once dirname(__FILE__) . '/admin-functions/admin-functions-edit-tags.php';
require_once dirname(__FILE__) . '/admin-functions/admin-functions-messages.php';
require_once dirname(__FILE__) . '/admin-functions/admin-functions-edit-general.php';
require_once dirname(__FILE__) . '/admin-functions/admin-functions-edit-album.php';
require_once dirname(__FILE__) . '/admin-functions/admin-functions-edit-image.php';
