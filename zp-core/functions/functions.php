...
function setexifvars() {
	...
	$_zp_exifvars = array(
			...
			'EXIFMake' => array('IFD0', 'Make', gettext('EXIF Camera Maker'), true, 52, true, 'string'),
			'EXIFModel' => array('IFD0', 'Model', gettext('EXIF Camera Model'), true, 52, true, 'string'),
			'EXIFDescription' => array('IFD0', 'ImageDescription', gettext('EXIF Image Title'), false, 52, true, 'string'),
			'IPTCObjectName' => array('IPTC', 'ObjectName', gettext('IPTC Object Name'), false, 256, true, 'string'),
			'IPTCImageHeadline' => array('IPTC', 'ImageHeadline', gettext('IPTC Image Headline'), false, 256, true, 'string'),
			'IPTCImageCaption' => array('IPTC', 'ImageCaption', gettext('IPTC Image Caption'), false, 2000, true, 'string'),
			'IPTCImageCaptionWriter' => array('IPTC', 'ImageCaptionWriter', gettext('IPTC Image Caption Writer'), false, 32, true, 'string'),
			'EXIFDateTime' => array('SubIFD', 'DateTime', gettext('EXIF Date and Time Taken'), true, 52, true, 'datetime'),
			'EXIFDateTimeOriginal' => array('SubIFD', 'DateTimeOriginal', gettext('EXIF Original Date and Time Taken'), true, 52, true, 'datetime'),
			'EXIFDateTimeDigitized' => array('SubIFD', 'DateTimeDigitized', gettext('EXIF Date and Time Digitized'), true, 52, true, 'datetime'),
			'IPTCDateCreated' => array('IPTC', 'DateCreated', gettext('IPTC Date Created'), false, 8, true, 'date'),
			'IPTCTimeCreated' => array('IPTC', 'TimeCreated', gettext('IPTC Time Created'), false, 11, true, 'time'),
			'IPTCDigitizeDate' => array('IPTC', 'DigitizeDate', gettext('IPTC Digital Creation Date'), false, 8, true, 'date'),
			'IPTCDigitizeTime' => array('IPTC', 'DigitizeTime', gettext('IPTC Digital Creation Time'), false, 11, true, 'time'),
			'EXIFArtist' => array('IFD0', 'Artist', gettext('EXIF Artist'), false, 52, true, 'string'),
			'IPTCImageCredit' => array('IPTC', 'ImageCredit', gettext('IPTC  Image Credit'), false, 32, true, 'string'),
			'IPTCByLine' => array('IPTC', 'ByLine', gettext('IPTC Byline'), false, 32, true, 'string'),
			'IPTCByLineTitle' => array('IPTC', 'ByLineTitle', gettext('IPTC Byline Title'), false, 32, true, 'string'),
			'IPTCSource' => array('IPTC', 'Source', gettext('IPTC Image Source'), false, 32, true, 'string'),
			'IPTCContact' => array('IPTC', 'Contact', gettext('IPTC Contact'), false, 128, true, 'string'),
			'EXIFCopyright' => array('IFD0', 'Copyright', gettext('EXIF Copyright Holder'), false, 128, true, 'string'),
			'IPTCCopyright' => array('IPTC', 'Copyright', gettext('IPTC Copyright Notice'), false, 128, true, 'string'),
			'IPTCKeywords' => array('IPTC', 'Keywords', gettext('IPTC Keywords'), false, 0, true, 'string'),
			'EXIFExposureTime' => array('SubIFD', 'ExposureTime', gettext('EXIF Shutter Speed'), true, 52, true, 'string'),
			'EXIFFNumber' => array('SubIFD', 'FNumber', gettext('EXIF Aperture'), true, 52, true, 'number'),
			'EXIFISOSpeedRatings' => array('SubIFD', 'ISOSpeedRatings', gettext('EXIF ISO Sensitivity'), true, 52, true, 'number'),
			'EXIFExposureBiasValue' => array('SubIFD', 'ExposureBiasValue', gettext('EXIF Exposure Compensation'), true, 52, true, 'string'),
			'EXIFMeteringMode' => array('SubIFD', 'MeteringMode', gettext('EXIF Metering Mode'), true, 52, true, 'string'),
			'EXIFFlash' => array('SubIFD', 'Flash', gettext('EXIF Flash Fired'), true, 52, true, 'string'),
			'EXIFImageWidth' => array('SubIFD', 'ExifImageWidth', gettext('EXIF Original Width'), false, 52, true, 'number'),
			'EXIFImageHeight' => array('SubIFD', 'ExifImageLength', gettext('EXIF Original Height'), false, 52, true, 'number'),
			'EXIFOrientation' => array('IFD0', 'Orientation', gettext('EXIF Orientation'), false, 52, true, 'string'),
			'EXIFSoftware' => array('IFD0', 'Software', gettext('EXIF Software'), false, 999, true, 'string'),
			'EXIFContrast' => array('SubIFD', 'Contrast', gettext('EXIF Contrast Setting'), false, 52, true, 'string'),
			'EXIFSharpness' => array('SubIFD', 'Sharpness', gettext('EXIF Sharpness Setting'), false, 52, true, 'string'),
			'EXIFSaturation' => array('SubIFD', 'Saturation', gettext('EXIF Saturation Setting'), false, 52, true, 'string'),
			'EXIFWhiteBalance' => array('SubIFD', 'WhiteBalance', gettext('EXIF White Balance'), false, 52, true, 'string'),
			'EXIFSubjectDistance' => array('SubIFD', 'SubjectDistanceRange', gettext('EXIF Subject Distance'), false, 52, true, 'number'),
			'EXIFFocalLength' => array('SubIFD', 'FocalLength', gettext('EXIF Focal Length'), true, 52, true, 'number'),
			'EXIFLensType' => array('SubIFD', 'LensModel', gettext('EXIF Lens Model'), false, 52, true, 'string'),
			'EXIFLensInfo' => array('SubIFD', 'LensInfo', gettext('EXIF Lens Info'), false, 52, true, 'string'),
			'EXIFFocalLengthIn35mmFilm' => array('SubIFD', 'FocalLengthIn35mmFilm', gettext('EXIF 35mm Focal Length Equivalent'), false, 52, true, 'string'),
			'IPTCCity' => array('IPTC', 'City', gettext('IPTC City'), false, 32, true, 'string'),
			'IPTCSubLocation' => array('IPTC', 'SubLocation', gettext('IPTC Sub-location'), false, 32, true, 'string'),
			'IPTCState' => array('IPTC', 'State', gettext('IPTC Province/State'), false, 32, true, 'string'),
			'IPTCLocationCode' => array('IPTC', 'LocationCode', gettext('IPTC Country/Primary Location Code'), false, 3, true, 'string'),
			'IPTCLocationName' => array('IPTC', 'LocationName', gettext('IPTC Country/Primary Location Name'), false, 64, true, 'string'),
			'IPTCContentLocationCode' => array('IPTC', 'ContentLocationCode', gettext('IPTC Content Location Code'), false, 3, true, 'string'),
			'IPTCContentLocationName' => array('IPTC', 'ContentLocationName', gettext('IPTC Content Location Name'), false, 64, true, 'string'),
			'EXIFGPSLatitude' => array('GPS', 'GPSLatitude', gettext('EXIF Latitude'), false, 52, true, 'number'),
			'EXIFGPSLatitudeRef' => array('GPS', 'GPSLatitudeRef', gettext('EXIF Latitude Reference'), false, 52, true, 'string'),
			'EXIFGPSLongitude' => array('GPS', 'GPSLongitude', gettext('EXIF Longitude'), false, 52, true, 'number'),
			'EXIFGPSLongitudeRef' => array('GPS', 'GPSLongitudeRef', gettext('EXIF Longitude Reference'), false, 52, true, 'string'),
			'EXIFGPSAltitude' => array('GPS', 'GPSAltitude', gettext('EXIF Altitude'), false, 52, true, 'number'),
			'EXIFGPSAltitudeRef' => array('GPS', 'GPSAltitudeRef', gettext('EXIF Altitude Reference'), false, 52, true, 'string'),
			'IPTCOriginatingProgram' => array('IPTC', 'OriginatingProgram', gettext('IPTC Originating Program'), false, 32, true, 'string'),
			'IPTCProgramVersion' => array('IPTC', 'ProgramVersion', gettext('IPTC Program Version'), false, 10, true, 'string'),
			...
			'VideoBitrate' => array('VIDEO', 'bitrate', gettext('Video Bitrate'), false, 32, true, 'number'),
			'VideoBitrate_mode' => array('VIDEO', 'bitrate_mode', gettext('Video Bitrate_Mode'), false, 32, true, 'string'),
			'VideoBits_per_sample' => array('VIDEO', 'bits_per_sample', gettext('Video Bits per sample'), false, 32, true, 'number'),
			'VideoCodec' => array('VIDEO', 'codec', gettext('Video Codec'), false, 32, true, 'string'),
			'VideoCompression_ratio' => array('VIDEO', 'compression_ratio', gettext('Video Compression Ratio'), false, 32, true, 'number'),
			'VideoDataformat' => array('VIDEO', 'dataformat', gettext('Video Dataformat'), false, 32, true, 'string'),
			'VideoEncoder' => array('VIDEO', 'encoder', gettext('Video File Encoder'), false, 10, true, 'string'),
			'VideoSamplerate' => array('VIDEO', 'Samplerate', gettext('Video Sample rate'), false, 32, true, 'number'),
			'VideoChannelmode' => array('VIDEO', 'channelmode', gettext('Video Channel Mode'), false, 32, true, 'string'),
			'VideoFormat' => array('VIDEO', 'format', gettext('VideoFormat'), false, 10, true, 'string'),
			'VideoChannels' => array('VIDEO', 'channels', gettext('Video Channels'), false, 10, true, 'number'),
			'VideoFramerate' => array('VIDEO', 'framerate', gettext('Video Frame Rate'), false, 32, true, 'number'),
			'VideoResolution_x' => array('VIDEO', 'resolution_x', gettext('Video X Resolution'), false, 32, true, 'number'),
			'VideoResolution_y' => array('VIDEO', 'resolution_y', gettext('Video Y Resolution'), false, 32, true, 'number'),
			'VideoAspect_ratio' => array('VIDEO', 'pixel_aspect_ratio', gettext('Video Aspect ratio'), false, 32, true, 'number'),
			'VideoPlaytime' => array('VIDEO', 'playtime_string', gettext('Video Play Time'), false, 10, true, 'number'),
...
function getImageMetadataValue($type = '', $value = '', $name = '') {
	...
	return imageMetaFormatter::formatDataOutput($name, $value, false);
}
