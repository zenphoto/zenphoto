...
/**
 *
 * ZenPhotoGraphics license agreement
 *
 */
...
<body>
	...
	<div id="main">
		<?php printTabs(); ?>
		<div id="content">
			<h1><?php echo gettext('ZenPhotoGraphics License agreement'); ?></h1>
			<div id="container">
				<p class="notebox">
				...
				if (!getOption('license_accepted')) {
					...
					?>
					<p class="buttons">
						<a href="<?php echo FULLWEBPATH . '/' . ZENFOLDER . '/license.php?licenseAccept&amp;XSRFToken=' . getXSRFToken('ZenphotoLicense'); ?>" alt="<?php echo gettext('You must accept this license to continue to use ZenPhotoGraphics.'); ?>"><?php echo gettext('I agree to these terms and conditions'); ?></a>
					</p>
					<br class="clearall">
					<?php
				}
