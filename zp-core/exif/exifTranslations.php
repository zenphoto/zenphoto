...
function exifTranslate($source) {
	...
	switch ($sw) {
		...
		case '!compulsory flash, light detected!' : return str_replace($matches[0], gettext('Compulsory Flash; Return light detected'), $source);
		case '!compulsory flash, light not detected!' : return str_replace($matches[0], gettext('Compulsory Flash; Return light not detected'), $source);
		...
		case '!flash, auto-mode, light detected!' : return str_replace($matches[0], gettext('Flash; Auto-Mode; Return light detected'), $source);
		case '!flash, auto-mode, light not detected!' : return str_replace($matches[0], gettext('Flash; Auto-Mode; Return light not detected'), $source);
		case '!flash, strobe, light detected!' : return str_replace($matches[0], gettext('Flash; strobe return str_replace($matches[0], light detected'), $source);
		case '!flash, strobe, light not detected!' : return str_replace($matches[0], gettext('Flash; strobe return str_replace($matches[0], light not detected'), $source);
		...
		case '!red eye, auto-mode, light detected!' : return str_replace($matches[0], gettext('Red Eye; Auto-Mode; Return light detected'), $source);
		case '!red eye, light not detected!' : return str_replace($matches[0], gettext('Red Eye; Auto-Mode; Return light not detected'), $source);
		case '!red eye, compulsory flash!' : return str_replace($matches[0], gettext('Red Eye; Compulsory Flash'), $source);
		case '!red eye, compulsory flash, light detected!' : return str_replace($matches[0], gettext('Red Eye; Compulsory Flash; Return light detected'), $source);
		case '!red eye, compulsory flash, light not detected!' : return str_replace($matches[0], gettext('Red Eye; Compulsory Flash; Return light not detected'), $source);
		case '!red eye, light detected!' : return str_replace($matches[0], gettext('Red Eye; Return light detected'), $source);
		case '!red eye, light not detected!' : return str_replace($matches[0], gettext('Red Eye; Return light not detected'), $source);
		case '!red-eye reduction!' : return str_replace($matches[0], gettext("Red-Eye Reduction"), $source);
