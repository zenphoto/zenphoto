...
$exifTranslate = array(
				...
				'!10s!'																																		 => gettext("10s"),
				'!1: normal (0 deg)!'																											 => gettext('1: Normal (0 deg)'),
				'!1st curtain sync!'																											 => gettext('1st curtain sync'),
				'!2: mirrored!'																														 => gettext('2: Mirrored'),
				...
				'!3: upside-down!'																												 => gettext('3: Upside-down'),
				'!4: upside-down mirrored!'																								 => gettext('4: Upside-down Mirrored'),
				'!5: 90 deg cw mirrored!'																									 => gettext('5: 90 deg CW Mirrored'),
				'!6: 90 deg ccw!'																													 => gettext('6: 90 deg CCW'),
				'!7: 90 deg ccw mirrored!'																								 => gettext('7: 90 deg CCW Mirrored'),
				'!8: 90 deg cw!'																													 => gettext('8: 90 deg CW'),
