...
class utf8 {
	...
	public $mb_sets;
	public $iconv_sets;
	public static $utf8_tables = array(
			'strtolower' => array(
	...
	function __construct() {
		$this->charsets = array(
						...
						"GB18030"		=> gettext("Chinese (PRC new)"),
						"GB2312"		=> gettext("Chinese (PRC old)"),
						"GBK"			=> gettext("Chinese (PRC simplified)"),
						...
						"ISO-8859-13" 	=> gettext("Baltic (ISO)"),
						"ISO-8859-14" 	=> gettext("Celtic (ISO)"),
						"ISO-8859-15" 	=> gettext("Latin 9 (ISO)"),
						"ISO-8859-16" 	=> gettext("South European (ISO)"),
						"KOI8-R" 		=> gettext("Cyrillic (KOI8-R)"),
						"KOI8-U" 		=> gettext("Cyrillic (KOI8-U)"),
						"SHIFT-JIS" 	=> gettext("Japanese (Shift-JIS)"),
						"TIS-620" 		=> gettext("Thai"),
						"US-ASCII" 		=> gettext("US-ASCII"),
						"UTF-7" 		=> gettext("Unicode (UTF-7)"),
						"UTF-8" 		=> gettext("Unicode (UTF-8)"),
						"UTF-16" 		=> gettext("Unicode (UTF-16)"),
		...
		if (function_exists('mb_convert_encoding')) {
			if (function_exists('mb_list_encodings')) {
				...
				$list = array(// from my PHP 5 mb_list_encodings list....
						"pass",
						"auto",
						"wchar",
						"byte2be",
		...
		if (function_exists('iconv')) {
			foreach ($this->charsets as $key => $encoding) {
				if (@iconv("UTF-8", "$key//IGNORE", "UTF-8") !== false) {
	...
	static function strtolower($str) {
		return strtr($str, utf8::$utf8_tables['strtolower']);
	}
	...
	static function strtoupper($str) {
		return strtr($str, utf8::$utf8_tables['strtoupper']);
	}
