			...
			<table class="bordered">
				<tr>
					<td valign='top'>
						...
						<form class="dirty-check" name="tag_delete" id="form_tagdelete" action="?delete=true&amp;tagsort=<?php echo html_encode($tagsort); ?>" method="post">
					...
					<td valign='top'>
						...
						<form class="dirty-check" name="tag_rename" id="form_tagrename" action="?rename=true&amp;tagsort=<?php echo html_encode($tagsort); ?>" method="post">
					...
					<td valign='top'>
						...
						<form class="dirty-check" name="new_tags" id="form_newtags" action="?newtags=true&amp;tagsort=<?php echo html_encode($tagsort); ?>" method="post">
